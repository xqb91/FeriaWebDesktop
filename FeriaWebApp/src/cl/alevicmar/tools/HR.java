...
public class HR {
    ...
    static public void mostrarMensaje(String mensaje) {
        JOptionPane.showMessageDialog(null, mensaje, "Feria Web Desktop Client", JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    static public Integer preguntar(String mensaje) {
        return JOptionPane.showConfirmDialog(null, mensaje, "Feria Web Desktop Client", JOptionPane.YES_NO_OPTION);
    }
    ...
    static public boolean esVacio(JPasswordField obj) {
        if(obj.getText().isEmpty()){
            mostrarError("El campo de contraseña esta vacío, por favor rellenelo");
            obj.requestFocus();
            return true;
        }else{
            return false;
    ...
    static public void seleccionarTodo(JTextField obj) {
        obj.selectAll();
    }
    ...
    static public boolean esVacio(JComboBox obj) {
        if(obj.getItemCount() > 0) {
            if(obj.getSelectedItem().toString().isEmpty()){
                mostrarError("Campo vacío detectado, por favor rellenelo");
                obj.requestFocus();
                return true;
            }else{
                return false;
