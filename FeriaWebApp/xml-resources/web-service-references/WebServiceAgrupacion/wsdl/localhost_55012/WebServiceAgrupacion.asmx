...
<html>
    ...
    <head><link rel="alternate" type="text/xml" href="/WebServiceAgrupacion.asmx?disco" />
    ...
    <title>
	WebServiceAgrupacion Servicio Web
</title></head>
  ...
  <body>
    ...
    <div id="content">
      ...
      <p class="heading1">WebServiceAgrupacion</p><br>

      

      <span>

          <p class="intro">Las operaciones siguientes son compatibles. Para una definición formal, revise la <a href="WebServiceAgrupacion.asmx?WSDL">descripción de servicios</a>. </p>
          
          
              <ul>
            
              <li>
                <a href="WebServiceAgrupacion.asmx?op=actualizaAgrupacion">actualizaAgrupacion</a>
              ...
              <li>
                <a href="WebServiceAgrupacion.asmx?op=buscaAgrupacion">buscaAgrupacion</a>
              ...
              <li>
                <a href="WebServiceAgrupacion.asmx?op=eliminaPais">eliminaPais</a>
              ...
              <li>
                <a href="WebServiceAgrupacion.asmx?op=guardarAgrupacion">guardarAgrupacion</a>
              ...
              <li>
                <a href="WebServiceAgrupacion.asmx?op=posicionAgrupacion">posicionAgrupacion</a>
              ...
              <li>
                <a href="WebServiceAgrupacion.asmx?op=retornaTodasLasAgrupaciones">retornaTodasLasAgrupaciones</a>
...
<script type="application/json" id="__browserLink_initializationData">
    {"appName":"Unknown","requestId":"d3cd8b18eebc46479d7516dbca98cab8"}
</script>
<script type="text/javascript" src="http://localhost:1917/8c9e537da6b946d891b5d3eaaf457074/browserLink" async="async"></script>
<!-- End Browser Link -->
